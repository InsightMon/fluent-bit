...
#ifndef FLB_OUT_LOGSTORE_H
#define FLB_OUT_LOGSTORE_H
...
#define FLB_LOGSTORE_CT              "Content-Type"
#define FLB_LOGSTORE_CT_JSON         "application/json"
#define FLB_LOGSTORE_URI             "/logstore/api/v1/push"
#define FLB_LOGSTORE_HOST            "127.0.0.1"
#define FLB_LOGSTORE_PORT            3100
#define FLB_LOGSTORE_HEADER_SCOPE    "X-Scope-OrgID"

#define FLB_LOGSTORE_KV_STR    0     /* sds string */
#define FLB_LOGSTORE_KV_RA     1     /* record accessor */
#define FLB_LOGSTORE_KV_K8S    2     /* kubernetes label */

/* Output line format */
#define FLB_LOGSTORE_FMT_JSON  0
#define FLB_LOGSTORE_FMT_KV    1

struct flb_logstore_kv {
    int val_type;                       /* FLB_LOGSTORE_KV_STR or FLB_LOGSTORE_KV_RA */
    ...
    struct mk_list _head;               /* link to flb_logstore->labels_list */
};
...
struct flb_logstore {
    ...
    struct mk_list labels_list;         /* list of flb_logstore_kv nodes */
